...
namespace POA.Web.Helpers
{
    public static class HtmlHelperExtensions
    {
        ...
        /// </summary>
        public static MvcHtmlString CheckBoxListFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TValue>> expression, IEnumerable<SelectListItem> items, string strListName, object htmlAttributes = null)
        {
            var listName = strListName;// ExpressionHelper.GetExpressionText(expression);
